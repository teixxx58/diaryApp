                    ...
                    <div class="card-body">
                        ...
                        <form action="javascript:void(0)" @submit="register" class="row" method="post">
                            ...
                            <div class="form-group col-12 my-2">
                                <label for="email" class="font-weight-bold">Eメール</label>
                            ...
                            <div class="form-group col-12 my-2">
                                <label for="password_confirmation" class="font-weight-bold">もう一度入力</label>
                            ...
                            <div class="col-12 text-center">
                                <label>アカウントをお持ちの場合 <router-link :to="{name:'login'}">ログイン</router-link></label>
                            </div>
                        </form>
                    </div>
                </div>
